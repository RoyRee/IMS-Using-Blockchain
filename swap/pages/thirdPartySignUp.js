...
class thirdPartySignUp extends Component{
...
onSubmit = async () =>{
    ...
    console.log(bytes);
		...
		try{
			...
			const address = await factory.methods.createThirdParty(bytes).send({from:account[0]});
     	    console.log(address);
			this.setState({loading:false});
			Router.pushRoute(`/thirdPartyLogin`);
		}catch(err){
    ...
    <Grid textAlign='center' style={{ height: '90%' }} verticalAlign='middle'>
      ...
      <Grid.Column style={{ maxWidth: 450 }}>
        <Header as='h2' color='teal' textAlign='center'>
           Make A New Third Party Account
        </Header>
        ...
        <Message>
         Existing user? <a href='/thirdPartyLogin'>Login</a>                                                                                                                                                                                                                                                                                                           
        </Message>
      </Grid.Column>
    </Grid>
